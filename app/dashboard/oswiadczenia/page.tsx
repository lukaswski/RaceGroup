          ...
          <table className="w-full table-fixed text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/30">
                <th className="w-[40%] px-4 py-3 text-left font-medium">Wydarzenie</th>
                <th className="w-[15%] px-4 py-3 text-left font-medium">Data</th>
                <th className="w-[25%] px-4 py-3 text-left font-medium">Oświadczenia</th>
